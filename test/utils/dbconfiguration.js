...
var reconfigureDb = function(inMemory){
  ...
  var currentPersistence = persistencefactory.model("sqlite:", {storage: storage, isolationLevel: Sequelize.Transaction.ISOLATION_LEVELS.SERIALIZABLE, logging: logger.verbose});
